...
back_button = Button(back_image, back_pressed_image, (10, 10), display)

back_1_button = Button(back_1_image, back_1_pressed_image, (10, 10), display)

no_button = Button(no_image, no_pressed_image, (WINDOW_SIZE[0] // 2 - no_image.get_width() // 2 + 70, 500), display)

yes_button = Button(yes_image, yes_pressed_image, (WINDOW_SIZE[0] // 2 - yes_image.get_width() // 2 - 70, 500), display)

records_button = Button(records_image, records_presed_image,
                        (WINDOW_SIZE[0] // 2 - records_image.get_width() // 2, 390), display)

one_button = Button(one_image, one_pressed_image, (WINDOW_SIZE[0] // 2 - one_image.get_width() // 2 - 100, 390), display)
two_button = Button(two_image, two_pressed_image, (WINDOW_SIZE[0] // 2 - two_image.get_width() // 2, 390), display)
three_button = Button(three_image, three_pressed_image, (WINDOW_SIZE[0] // 2 - three_image.get_width() // 2 + 100, 390), display)
